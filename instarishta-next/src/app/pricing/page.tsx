...
const COMPARE_ROWS = [
  ...
  { feature: 'Validity',              silver: '90 days',   gold: '180 days',  diamond: '365 days', platinum: '540 days' },
];

const FAQS = [
  {
    q: 'Can I upgrade my plan later?',
    a: 'Yes. You can upgrade from any plan to a higher tier at any time. Your remaining validity is prorated and carried forward.',
  },
  {
