...
const SECTIONS = [
  ...
  {
    id: '2',
    title: 'About InstaRishta & Our Legal Entity',
    body: `InstaRishta is a Muslim matrimonial and matchmaking platform based in Hyderabad, India. Our platform facilitates introductions between Muslim individuals and families seeking halal marriage proposals. InstaRishta is not a dating service. We operate as an introduction platform only and do not guarantee any matrimonial outcome.\n\nInstaRishta (instarishta.me) is owned and operated by ${ENTITY.legalName}, a business registered in India with its place of business at ${ENTITY.address}. ${ENTITY.shortName} is the entity responsible for this platform and is the contracting party under these Terms. The same entity also operates Xavio (xavio.in). Any commercial message you receive from us over SMS, RCS or WhatsApp is sent by ${ENTITY.shortName} as the registered principal entity.`,
  },
  {
    id: '3',
    title: 'Eligibility',
  ...
  {
    id: '9',
    title: 'Free Service, Memberships & Payments',
    body: `Browsing profiles, viewing biodatas and playing profile audio on InstaRishta are free of charge. A free account does not include contact credits; your first paid purchase adds ${PURCHASE_BONUS_CREDITS} bonus contact credits on top of the plan allowance.\n\nRevealing a candidate's private contact details requires a contact credit. Credits are obtained through a paid membership (the 6 Months Plan or the 1 Year Plan) or a one-time top-up. Membership credits refill to the full monthly allowance on the same date each month for the duration of the term; unused monthly credits are forfeited at each reset and do not carry over. One-time top-up credits do not reset and do not expire. Contact details you have already unlocked remain accessible to you permanently.\n\nMemberships are prepaid for a fixed term and DO NOT renew automatically. There is no auto-debit, standing instruction or recurring mandate on your card or UPI, and no amount is ever charged without you initiating a fresh payment. When a term ends, credits stop refilling.\n\nExpressing an "interest" in a profile is free and does not consume a contact credit. When expressing an interest you may attach only one of the pre-written messages we provide; free-text messages to advertisers are not accepted. Interests are private: they are sent to InstaRishta and passed to the relevant advertiser, and are never published on the platform or shown to other users. The number of interests you may send is limited per account and is subject to a fair-use daily cap to prevent bulk or indiscriminate sending; sending interests in an automated, bulk or harassing manner is a breach of these terms and may result in suspension.\n\nA contact credit is consumed only when you choose to reveal an advertiser's contact details after that advertiser has indicated they wish to connect. If an advertiser declines or does not respond, no credit is consumed. Revealing the same contact more than once does not consume additional credits. InstaRishta relays interests on a best-efforts basis and does not guarantee that any advertiser will respond, agree to connect, or continue any conversation.\n\nALL PAYMENTS ARE FINAL AND NON-REFUNDABLE. Once a membership is activated it cannot be cancelled, refunded, transferred, exchanged or converted to credit, in whole or in part, irrespective of usage. Because the paid service consists of disclosing private contact information that cannot be returned once revealed, we do not operate a refund process. Please use the free tier to evaluate the platform and contact us with any questions before making a payment. See our No-Refund Policy for full terms.\n\nAll prices are in Indian Rupees (₹) and inclusive of applicable taxes. Prices may change at any time; changes apply only to purchases made afterwards and do not entitle you to any adjustment on a membership already purchased.`,
  },
  {
    id: '10',
