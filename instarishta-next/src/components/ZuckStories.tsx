...
// @ts-expect-error — zuck.js ships types but its default export's call
// signature (element, options) isn't narrow enough for the options object
// literal below without a local cast.
